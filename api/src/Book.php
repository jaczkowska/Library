...
class Book implements JsonSerializable {
    ...
    public function create(mysqli $connection) {
        $result = $connection->query("INSERT INTO Book(title, author, description) VALUES ('$this->title','$this->author', '$this->description')");
    ...
    public function update(mysqli $connection, $id) {
        ...
        $result = $connection->query("UPDATE Book SET title = '$newTitle', author =  '$newAuthor', description =  '$newDesc' WHERE  id = $id;");
        if ($result) {
            return true;
        } else {
            return false;
